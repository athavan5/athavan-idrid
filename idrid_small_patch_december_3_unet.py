...
# Define your source and destination folder paths
    og_image_train = "A. Segmentation/1. Original Images/a. Training Set"  # Replace with your actual paths
...
IMG_DIR = BASE / "A. Segmentation/1. Original Images/c. All Images"
MASK_ROOT = BASE / "A. Segmentation/2. All Segmentation Groundtruths"
...
OUT_ROOT = BASE / "A. Segmentation/3. WDES_Splits"
...
def main():
    ...
    print("Train images dir:", img_train_folder)
    print("Exists?", os.path.exists(img_train_folder))
    print("Files:", os.listdir(img_train_folder) if os.path.exists(img_train_folder) else "NONE")

"""Apply Augmentations"""

# Your directories
img_train_folder = OUT_ROOT / "train/images"
mask_train_root = OUT_ROOT / "train/masks"   # contains 4 subfolders

img_val_folder = OUT_ROOT / "val/images"
mask_val_root = OUT_ROOT / "val/masks"

img_test_folder   = OUT_ROOT / "test/images"
mask_test_root    = OUT_ROOT / "test/masks"
